...
The repository currently has a Python/FastAPI backend scaffold, SQLite-first project layout, placeholder frontend folder, and generated wiki/raw/data directories.
